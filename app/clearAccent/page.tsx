        ...
        <div className="relative mx-auto max-w-6xl px-5">
          ...
          <header className="flex items-center justify-between py-7">
            ...
            <nav className="hidden items-center gap-5 text-sm text-white/60 lg:flex">
              ...
              <a className="transition hover:text-white" href="/clearAccent/PrivacyPolicy">
                Privacy Policy
              </a>
              <a className="transition hover:text-white" href="/clearAccent/TermsOfService">
                Terms of Service
              </a>
            </nav>
          </header>
          ...
          <section className="grid items-center gap-12 pb-20 pt-10 lg:grid-cols-2 lg:gap-10 lg:pb-28 lg:pt-14">
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-white/70">
                See how American your accent is. Get instant feedback on{" "}
